...
function createStarField(): THREE.Points {
  ...
  for (let i = 0; i < STAR_COUNT; i++) {
    ...
    // Subtle color variation — mostly white, some warm, some cool
...
export default function Globe() {
  ...
  useEffect(() => {
    ...
    // Second atmosphere layer (front side, subtler) for depth
    ...
    // Subtle ambient light (so nothing is pure black)
    ...
    controls.addEventListener('end', () => {
      ...
      }, 3000); // Resume auto-rotate 3s after interaction stops
    });
    ...
    function animate() {
      ...
      // Update sun direction every ~60 seconds (no need for per-frame)
